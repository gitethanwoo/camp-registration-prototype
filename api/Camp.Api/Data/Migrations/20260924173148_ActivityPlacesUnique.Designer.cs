...
namespace Camp.Api.Data.Migrations
{
    ...
    [Migration("20260924173148_ActivityPlacesUnique")]
    partial class ActivityPlacesUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.ActivityAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegistrationId", "Period")
                        .IsUnique();

                    b.ToTable("ActivityAssignments", (string)null);
                });

            modelBuilder.Entity("Camp.Api.Features.Activities.ActivityBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ActivityBlocks", (string)null);
                });

            modelBuilder.Entity("Camp.Api.Features.Activities.ActivityPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegistrationId", "Period", "Rank")
                        .IsUnique();

                    b.ToTable("ActivityPreferences", (string)null);
                });

            modelBuilder.Entity("Camp.Api.Features.Activities.ActivitySlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BlockId", "ActivityId", "Period")
                        .IsUnique();

                    b.ToTable("ActivitySlots", null, t =>
                        {
                            t.HasCheckConstraint("CK_ActivitySlot_Period", "[Period] BETWEEN 1 AND 3");
                        });
                });

            modelBuilder.Entity("Camp.Api.Features.Activities.CabinmateRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MatchedRegistrationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MatchedRegistrationId");

                    b.HasIndex("RegistrationId");

                    b.HasIndex("SessionId");

                    b.ToTable("CabinmateRequests", (string)null);
                });
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.ActivityAssignment", b =>
                {
                    ...
                    b.HasOne("Camp.Api.Features.Activities.ActivitySlot", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.ActivityPreference", b =>
                {
                    b.HasOne("Camp.Api.Features.Activities.Activity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.ActivitySlot", b =>
                {
                    ...
                    b.HasOne("Camp.Api.Features.Activities.ActivityBlock", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Camp.Api.Features.Activities.CabinmateRequest", b =>
                {
                    b.HasOne("Camp.Api.Domain.Registration", null)
                        .WithMany()
                        .HasForeignKey("MatchedRegistrationId")
                        .OnDelete(DeleteBehavior.NoAction);
