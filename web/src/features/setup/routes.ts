...
export const adminRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: {
      roles: adminRoles,
      title: 'Programs',
      nav: { group: 'Setup', label: 'Programs', icon: LayoutGrid, order: 5 },
    },
  },
  {
    path: 'setup/sessions',
    ...
    meta: { roles: adminRoles, title: 'Session setup' },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      nav: { group: 'Setup', label: 'Pricing', icon: DollarSign, order: 20 },
    },
  },
  {
    ...
    meta: {
      ...
      nav: { group: 'Setup', label: 'Discount rules', icon: TicketPercent, order: 30 },
    },
  },
  {
    path: 'setup/waivers',
    ...
    meta: {
      ...
      nav: { group: 'Setup', label: 'Waivers', icon: FilePen, order: 40 },
    },
  },
  {
    path: 'setup/audit',
